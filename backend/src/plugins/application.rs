...
use crate::plugins::providers::metadata::ehentai::{
...
use crate::plugins::providers::metadata::nhentai::{
...
impl PluginHandler {
    ...
    pub async fn execute_plugin_for_archive(
        ...
        if result.is_ok() {
            ...
            if let Err(err) =
                crate::services::ai_service::enqueue_title_translation(&pool, &archive_id).await
            {
...
async fn execute_ehentai_metadata_and_persist(
    ...
    serde_json::to_string(&json!({
        ...
        "archive_id": archive.id,
        "gallery_url": crate::plugins::providers::metadata::ehentai::source_url(&gallery_id, &token),
        "tags_applied": stats.tags_applied,
        "tags_skipped": stats.tags_skipped,
        "notes": stats.notes,
    }))
...
async fn execute_nhentai_metadata_and_persist(
    ...
    serde_json::to_string(&json!({
        ...
        "archive_id": archive.id,
        "gallery_url": crate::plugins::providers::metadata::nhentai::source_url(&gallery_id),
        "tags_applied": stats.tags_applied,
        "tags_skipped": stats.tags_skipped,
        "notes": stats.notes,
    }))

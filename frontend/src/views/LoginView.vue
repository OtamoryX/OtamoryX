<template>
  ...
  <div class="login-background min-h-screen w-full relative overflow-hidden">
    ...
    <div class="relative z-10 min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <GlassCard size="lg" radius="2xl" glow-effect shine-effect class="w-full max-w-md">
        <!-- 标题区域 -->
        <div class="text-center mb-8">
          <div class="flex justify-center mb-4">
            <div class="w-20 h-20 flex items-center justify-center">
              <img src="/icon.png" alt="OtamoryX Logo" class="w-20 h-20 rounded-2xl shadow-lg">
            </div>
          </div>
        ...
        <!-- 初始化表单 -->
        <form v-else-if="isInitializing" @submit.prevent="handleInitialize" class="space-y-6">
          <div class="space-y-4">
            <GlassInput
        ...
        <div v-if="error" class="mt-6">
          <GlassCard size="sm" class="bg-red-500/20 border-red-400/30">

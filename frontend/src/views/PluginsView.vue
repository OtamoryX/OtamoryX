  ...
  <div class="container mx-auto px-4 py-6">
    ...
    <div class="flex justify-between items-center mb-6">
      <div>
        ...
        <p class="text-gray-600">管理系统插件和扩展功能</p>
      </div>
    ...
    <div class="bg-white shadow rounded-lg overflow-hidden">
      ...
      <div v-else-if="error" class="p-6 text-center text-red-600">
        <p>{{ error }}</p>
        <button @click="loadPlugins" class="mt-2 text-blue-600 hover:text-blue-700">重试</button>
      </div>

      <div v-else-if="plugins.length === 0" class="p-6 text-center text-gray-500">
        <svg class="w-12 h-12 mx-auto mb-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
                d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" />
        </svg>
        <p class="text-lg font-medium mb-2">暂无插件</p>
        <p class="text-gray-600">点击"安装插件"按钮开始添加功能扩展</p>
      </div>
        ...
        >
          <div class="flex items-start justify-between">
            <div class="flex-1">
              ...
              <p v-if="plugin.description" class="text-gray-600 mb-3">
                {{ plugin.description }}
              </p>
    ...
    <!-- 安装插件模态框 -->
    <div v-if="showInstallModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50">
      <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
        <div class="mt-3">
          <h3 class="text-lg font-medium text-gray-900 mb-4 text-center">安装插件</h3>
          
          <form @submit.prevent="installPluginSubmit" class="space-y-4">
            <div>
            ...
            <div v-if="selectedFile" class="bg-gray-50 p-3 rounded-md">
    ...
    <!-- 卸载确认模态框 -->
    <div v-if="showUninstallModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50">
      <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
        <div class="mt-3 text-center">
          ...
          <h3 class="text-lg font-medium text-gray-900 mb-2">确认卸载</h3>

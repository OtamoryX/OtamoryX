  ...
  <BasePageView theme="library">
    ...
    />
      ...
      <div class="mb-6">
        <GlassCard size="sm" radius="lg" class="mb-6">
          <div class="flex items-center justify-between">
            <h1 class="text-2xl font-bold text-white">
              <svg class="w-8 h-8 inline-block mr-3 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <!-- 搜索栏 -->
        <GlassCard size="sm" radius="lg" class="max-w-2xl mb-6">
          <div class="space-y-4">
            ...
            <div v-if="showAdvancedSearch" class="space-y-4">
              <GlassCard size="sm" radius="md" class="bg-black/20">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <!-- 添加时间筛选 -->
                  <div>
                    <label class="block text-sm font-medium text-white mb-2">添加时间</label>
                    <div class="space-y-2">
                      <div>
                        <label class="block text-xs text-white/70 mb-1">从</label>
                        <input
                      ...
                      <div>
                        <label class="block text-xs text-white/70 mb-1">到</label>
                        <input
                  ...
                  <!-- 最后阅读时间筛选 -->
                  <div>
                    <label class="block text-sm font-medium text-white mb-2">最后阅读时间</label>
                    <div class="space-y-2">
                      <div>
                        <label class="block text-xs text-white/70 mb-1">从</label>
                        <input
                  ...
                  <!-- 页数筛选 -->
                  <div>
                    <label class="block text-sm font-medium text-white mb-2">页数范围</label>
                    <div class="grid grid-cols-2 gap-2">
                      <div>
                        <label class="block text-xs text-white/70 mb-1">最少</label>
                        <input
                      ...
                      <div>
                        <label class="block text-xs text-white/70 mb-1">最多</label>
                        <input
                  ...
                  <!-- 排序 -->
                  <div>
                    <label class="block text-sm font-medium text-white mb-2">排序方式</label>
                    <div class="space-y-2">
                      <select
                      ...
                      >
                        <option value="" class="text-gray-900">默认</option>
                        <option value="title" class="text-gray-900">标题</option>
                        <option value="createdAt" class="text-gray-900">添加时间</option>
                        <option value="lastReadAt" class="text-gray-900">最后阅读时间</option>
                        <option value="pageCount" class="text-gray-900">页数</option>
                        <option value="fileSize" class="text-gray-900">文件大小</option>
                      </select>
                      <select
                        v-model="advancedSearch.sortOrder"
                        class="w-full px-3 py-2 bg-white/10 border border-white/20 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-blue-400 focus:bg-white/15"
                      >
                        <option value="desc" class="text-gray-900">降序</option>
                        <option value="asc" class="text-gray-900">升序</option>
                      </select>
                    </div>
                  </div>
                </div>
        ...
        <!-- 错误信息 -->
        <GlassCard v-if="error" size="sm" radius="lg" class="mb-6 bg-red-500/20 border-red-400/30">
        ...
        <!-- 漫画网格 -->
        <GlassCard v-if="isLoading" size="md" radius="lg" class="text-center">
        ...
        <GlassCard v-else-if="archives.length === 0" size="md" radius="lg" class="text-center">
          <div class="text-white/70">
            <svg class="w-16 h-16 mx-auto mb-4 text-white/40" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 011-1h6a1 1 0 011 1v2M7 7v2m10-2v2" />
            </svg>
        ...
        <!-- 分页控件 -->
        <GlassCard v-if="totalPages > 1" size="sm" radius="lg" class="mt-8">
          <div class="flex items-center justify-center space-x-2">
            ...
            <div class="flex items-center space-x-1">
              ...
              <!-- 左侧省略号 -->
              <span v-if="showLeftEllipsis" class="px-2 text-white/50">...</span>
              ...
              <!-- 右侧省略号 -->
              <span v-if="showRightEllipsis" class="px-2 text-white/50">...</span>

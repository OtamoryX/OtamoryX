<template>
  ...
  >
    ...
    <!-- 光泽效果 -->
    <div v-if="glowEffect" class="glass-shine absolute inset-0 opacity-20"></div>
  </button>
</template>
...
const variantClasses = computed(() => {
  const variantMap = {
    primary: 'text-white bg-blue-600/80 border-blue-400/30 hover:bg-blue-600/90',
    secondary: 'text-gray-300 bg-gray-600/80 border-gray-400/30 hover:bg-gray-600/90',
    success: 'text-white bg-green-600/80 border-green-400/30 hover:bg-green-600/90',
    danger: 'text-white bg-red-600/80 border-red-400/30 hover:bg-red-600/90',
    warning: 'text-white bg-yellow-600/80 border-yellow-400/30 hover:bg-yellow-600/90',

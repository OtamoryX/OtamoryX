      ...
      <section class="space-y-4">
        ...
        <div class="space-y-3">
          <div>
            ...
            <p class="text-white break-words">{{ archiveInfo?.title || '加载中...' }}</p>
          </div>
          <div class="grid grid-cols-2 gap-3">
            ...
            <div>
              ...
              <p class="text-white">{{ formatFileSize(archiveInfo?.fileSize) }}</p>
            </div>
          </div>
          <div>
            <p class="text-sm text-gray-400 mb-1">文件路径</p>
            <p class="text-xs text-gray-300 break-all font-mono bg-white/5 rounded p-2">{{ archiveInfo?.path }}</p>
          </div>
        </div>
      </section>
      ...
      <section class="space-y-4">
        ...
        <div class="grid grid-cols-2 gap-3">
          <button
            ...
            class="p-3 bg-white/10 hover:bg-white/20 rounded-lg transition-colors text-left"
          >
            <div class="text-sm text-gray-300 mb-1">显示模式</div>
            <div class="text-white font-medium">{{ displayModeLabel }}</div>
          </button>
          <button
          ...
          >
            ...
            <div class="text-white font-medium">{{ readingModeLabel }}</div>
          </button>
        </div>
      </section>

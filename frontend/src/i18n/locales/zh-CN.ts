  ...
  aiSettings: {
    ...
    taskQueue: {
      ...
      counts: {
        ...
        waitingForModel: "等待模型 {count}",
        waitingForDependency: "等待依赖 {count}",
      ...
      tasks: {
        ...
        titleLanguageDetection: "标题语言识别",
        tagLocalization: "标签中文翻译",
        contentAnalysis: "自动标签",
        contentAnalysisSynthesize: "主题提取（已停用）",
        contentAnalysisCanonicalize: "主题归并（已停用）",
        ocrExtract: "OCR 提取",

...
class="relative">
              ...
              <div
                v-if="showAdminMenu"
                data-dropdown="admin"
                class="absolute right-0 mt-2 w-48 bg-white/10 backdrop-blur-lg border border-white/20 rounded-lg shadow-2xl z-20"
              >
                <div class="py-1">
                  <RouterLink
                    to="/admin/users"
            ...
            <div class="relative">
              ...
              >
                <div class="py-1">
                  <div
                    class="px-4 py-2 text-sm text-white/70 border-b border-white/20 mx-1 mt-1"
                  >
